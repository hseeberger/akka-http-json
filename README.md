...
The latest version of akka-http-json depends on akka-http 2.0 – there's an old version 1.1.0 which depends on akka-http 1.0.
...
libraryDependencies ++= List(
  "de.heikoseeberger" %% "akka-http-json4s" % "1.4.0", // or 1.1.0 for akka-http 1.0
  ...
)
```
