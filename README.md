...
**pekko-http-json is under development an no releases will be made until after Apache Pekko HTTP is released.**

This is a fork of [akka-http-json](https://github.com/hseeberger/akka-http-json).
